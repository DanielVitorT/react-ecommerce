...
import { Fake, PageArea, OthersArea, BreadCrumb } from "./styled";
        ...
        <PageContainer>
            {adInfo.category &&
                <BreadCrumb>
                    ...
                    /
                    <Link to={`/ads?states=${adInfo.stateName}&cat=${adInfo.category.slug}`}>{adInfo.category.name}</Link>
                    / {adInfo.title}
                </BreadCrumb>
            }
            <PageArea>
                    ...
                    <div className="box">
                        ...
                        <div className="adInfo">
                            ...
                            <div className="adDescription">
                                ...
                                <hr/>
                                {adInfo.views &&
                                    <small>Visualizaçôes: {adInfo.views}</small>
                                }
                            </div>
                        </div>
                    </div>
